...
part of 'single_page_status.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$SinglePageStatus extends SinglePageStatus {
  @override
  ...
  factory _$SinglePageStatus(
          [void Function(SinglePageStatusBuilder)? updates]) =>
      (new SinglePageStatusBuilder()..update(updates))._build();

  _$SinglePageStatus._(
      {this.commentsCount,
      this.conditions,
      this.contributors,
      this.excerpt,
  ...
  @override
  SinglePageStatus rebuild(void Function(SinglePageStatusBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SinglePageStatusBuilder toBuilder() =>
      new SinglePageStatusBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SinglePageStatus &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SinglePageStatus')
...
class SinglePageStatusBuilder
    implements Builder<SinglePageStatus, SinglePageStatusBuilder> {
  _$SinglePageStatus? _$v;
  ...
  SinglePageStatusBuilder() {
    SinglePageStatus._defaults(this);
  }

  SinglePageStatusBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(SinglePageStatus other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$SinglePageStatus;
  }

  @override
  void update(void Function(SinglePageStatusBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  SinglePageStatus build() => _build();

  _$SinglePageStatus _build() {
    _$SinglePageStatus _$result;
    try {
      _$result = _$v ??
          new _$SinglePageStatus._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'SinglePageStatus', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
