...
@BuiltValue()
abstract class PolicyList implements Built<PolicyList, PolicyListBuilder> {
  ...
  factory PolicyList([void updates(PolicyListBuilder b)]) = _$PolicyList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PolicyListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PolicyList> get serializer => _$PolicyListSerializer();
}

class _$PolicyListSerializer implements PrimitiveSerializer<PolicyList> {
  @override
  final Iterable<Type> types = const [PolicyList, _$PolicyList];

  @override
  final String wireName = r'PolicyList';
  ...
  void _deserializeProperties(
    ...
    required PolicyListBuilder result,
  ...
  PolicyList deserialize(
    ...
    final result = PolicyListBuilder();
