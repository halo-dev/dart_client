...
@BuiltValue()
abstract class GroupList implements Built<GroupList, GroupListBuilder> {
  ...
  factory GroupList([void updates(GroupListBuilder b)]) = _$GroupList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GroupListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GroupList> get serializer => _$GroupListSerializer();
}

class _$GroupListSerializer implements PrimitiveSerializer<GroupList> {
  @override
  final Iterable<Type> types = const [GroupList, _$GroupList];

  @override
  final String wireName = r'GroupList';
  ...
  void _deserializeProperties(
    ...
    required GroupListBuilder result,
