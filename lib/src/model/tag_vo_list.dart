...
@BuiltValue()
abstract class TagVoList implements Built<TagVoList, TagVoListBuilder> {
  ...
  factory TagVoList([void updates(TagVoListBuilder b)]) = _$TagVoList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TagVoListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TagVoList> get serializer => _$TagVoListSerializer();
}

class _$TagVoListSerializer implements PrimitiveSerializer<TagVoList> {
  @override
  final Iterable<Type> types = const [TagVoList, _$TagVoList];

  @override
  final String wireName = r'TagVoList';
  ...
  void _deserializeProperties(
    ...
    required TagVoListBuilder result,
  ...
  @override
  TagVoList deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = TagVoListBuilder();
