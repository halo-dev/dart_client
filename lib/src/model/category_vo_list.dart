...
@BuiltValue()
abstract class CategoryVoList implements Built<CategoryVoList, CategoryVoListBuilder> {
  ...
  BuiltList<CategoryVo> get items;
  ...
  factory CategoryVoList([void updates(CategoryVoListBuilder b)]) = _$CategoryVoList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CategoryVoListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CategoryVoList> get serializer => _$CategoryVoListSerializer();
}

class _$CategoryVoListSerializer implements PrimitiveSerializer<CategoryVoList> {
  @override
  final Iterable<Type> types = const [CategoryVoList, _$CategoryVoList];

  @override
  final String wireName = r'CategoryVoList';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CategoryVoList object, {
  ...
  void _deserializeProperties(
    ...
    required CategoryVoListBuilder result,
  ...
  @override
  CategoryVoList deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CategoryVoListBuilder();
