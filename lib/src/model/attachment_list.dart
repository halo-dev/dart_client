...
@BuiltValue()
abstract class AttachmentList implements Built<AttachmentList, AttachmentListBuilder> {
  ...
  BuiltList<Attachment> get items;
  ...
  factory AttachmentList([void updates(AttachmentListBuilder b)]) = _$AttachmentList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AttachmentListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AttachmentList> get serializer => _$AttachmentListSerializer();
}

class _$AttachmentListSerializer implements PrimitiveSerializer<AttachmentList> {
  @override
  final Iterable<Type> types = const [AttachmentList, _$AttachmentList];

  @override
  final String wireName = r'AttachmentList';
  ...
  void _deserializeProperties(
    ...
    required AttachmentListBuilder result,
  ...
  @override
  AttachmentList deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AttachmentListBuilder();
