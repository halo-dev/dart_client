...
abstract class CommentList implements Built<CommentList, CommentListBuilder> {
  ...
  factory CommentList([void updates(CommentListBuilder b)]) = _$CommentList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CommentListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CommentList> get serializer => _$CommentListSerializer();
}

class _$CommentListSerializer implements PrimitiveSerializer<CommentList> {
  @override
  final Iterable<Type> types = const [CommentList, _$CommentList];

  @override
  final String wireName = r'CommentList';
  ...
  void _deserializeProperties(
    ...
    required CommentListBuilder result,
  ...
  @override
  CommentList deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CommentListBuilder();
