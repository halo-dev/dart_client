...
@BuiltValue()
abstract class ReplyList implements Built<ReplyList, ReplyListBuilder> {
  ...
  factory ReplyList([void updates(ReplyListBuilder b)]) = _$ReplyList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ReplyListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ReplyList> get serializer => _$ReplyListSerializer();
}

class _$ReplyListSerializer implements PrimitiveSerializer<ReplyList> {
  @override
  final Iterable<Type> types = const [ReplyList, _$ReplyList];

  @override
  final String wireName = r'ReplyList';
  ...
  void _deserializeProperties(
    ...
    required ReplyListBuilder result,
  ...
  @override
  ReplyList deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ReplyListBuilder();
