...
part 'list_result_reply_vo.g.dart';
...
@BuiltValue()
abstract class ListResultReplyVo implements Built<ListResultReplyVo, ListResultReplyVoBuilder> {
  ...
  factory ListResultReplyVo([void updates(ListResultReplyVoBuilder b)]) = _$ListResultReplyVo;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ListResultReplyVoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ListResultReplyVo> get serializer => _$ListResultReplyVoSerializer();
}

class _$ListResultReplyVoSerializer implements PrimitiveSerializer<ListResultReplyVo> {
  @override
  final Iterable<Type> types = const [ListResultReplyVo, _$ListResultReplyVo];

  @override
  final String wireName = r'ListResultReplyVo';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ListResultReplyVo object, {
  ...
  void _deserializeProperties(
    ...
    required ListResultReplyVoBuilder result,
  ...
  @override
  ListResultReplyVo deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ListResultReplyVoBuilder();
