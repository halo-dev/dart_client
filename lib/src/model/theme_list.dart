...
import 'package:halo_client/src/model/theme.dart';
...
@BuiltValue()
abstract class ThemeList implements Built<ThemeList, ThemeListBuilder> {
  ...
  factory ThemeList([void updates(ThemeListBuilder b)]) = _$ThemeList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ThemeListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ThemeList> get serializer => _$ThemeListSerializer();
}

class _$ThemeListSerializer implements PrimitiveSerializer<ThemeList> {
  @override
  final Iterable<Type> types = const [ThemeList, _$ThemeList];

  @override
  final String wireName = r'ThemeList';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType: const FullType(BuiltList, [FullType(Theme)]),
    );
    yield r'last';
    yield serializers.serialize(
      object.last,
  ...
  void _deserializeProperties(
    ...
    required ThemeListBuilder result,
