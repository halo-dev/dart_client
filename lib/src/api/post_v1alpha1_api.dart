...
import 'package:halo_client/src/model/post_list.dart';
...
class PostV1alpha1Api {
  ...
  const PostV1alpha1Api(this._dio, this._serializers);
  ...
  Future<Response<Post>> createPost({ 
    ...
    final _path = r'/apis/content.halo.run/v1alpha1/posts';
  ...
  Future<Response<void>> deletePost({ 
    ...
    final _path = r'/apis/content.halo.run/v1alpha1/posts/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PostList>> listPost({ 
    int? page,
    int? size,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PostList),
      ) as PostList;
