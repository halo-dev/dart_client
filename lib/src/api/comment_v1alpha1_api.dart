...
import 'package:halo_client/src/model/comment_list.dart';
...
class CommentV1alpha1Api {
  ...
  const CommentV1alpha1Api(this._dio, this._serializers);
  ...
  Future<Response<Comment>> createComment({ 
    ...
    final _path = r'/apis/content.halo.run/v1alpha1/comments';
    ...
    try {
      ...
      _bodyData = comment == null ? null : _serializers.serialize(comment, specifiedType: _type);
  ...
  Future<Response<void>> deleteComment({ 
    ...
    final _path = r'/apis/content.halo.run/v1alpha1/comments/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CommentList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CommentList>> listComment({ 
    int? page,
    int? size,
    ...
    CommentList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CommentList),
      ) as CommentList;
  ...
  /// Returns a [Future] containing a [Response] with a [Comment] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Comment>> patchComment({ 
    required String name,
