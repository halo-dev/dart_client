...
class AttachmentV1alpha1Api {
  ...
  const AttachmentV1alpha1Api(this._dio, this._serializers);
  ...
  Future<Response<Attachment>> createAttachment({ 
    ...
    final _path = r'/apis/storage.halo.run/v1alpha1/attachments';
    ...
    try {
      const _type = FullType(Attachment);
      _bodyData = attachment == null ? null : _serializers.serialize(attachment, specifiedType: _type);
  ...
  Future<Response<void>> deleteAttachment({ 
    ...
    final _path = r'/apis/storage.halo.run/v1alpha1/attachments/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Attachment] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Attachment>> getAttachment({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AttachmentList>> listAttachment({ 
    int? page,
    int? size,
  ...
  /// Returns a [Future] containing a [Response] with a [Attachment] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Attachment>> patchAttachment({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [Attachment] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Attachment>> updateAttachment({ 
    required String name,
    Attachment? attachment,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
