...
import 'package:halo_client/src/model/secret_list.dart';
...
class SecretV1alpha1Api {
  ...
  const SecretV1alpha1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Secret] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Secret>> createSecret({ 
    Secret? secret,
    ...
    final _path = r'/api/v1alpha1/secrets';
    ...
    try {
      const _type = FullType(Secret);
      _bodyData = secret == null ? null : _serializers.serialize(secret, specifiedType: _type);
  ...
  Future<Response<void>> deleteSecret({ 
    ...
    final _path = r'/api/v1alpha1/secrets/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Secret] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Secret>> getSecret({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SecretList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SecretList>> listSecret({ 
    int? page,
    int? size,
    ...
    SecretList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SecretList),
      ) as SecretList;
  ...
  /// Returns a [Future] containing a [Response] with a [Secret] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Secret>> patchSecret({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [Secret] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Secret>> updateSecret({ 
    required String name,
    Secret? secret,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
