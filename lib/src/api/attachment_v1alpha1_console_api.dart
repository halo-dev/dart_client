...
class AttachmentV1alpha1ConsoleApi {
  ...
  const AttachmentV1alpha1ConsoleApi(this._dio, this._serializers);
  ...
  Future<Response<Attachment>> externalTransferAttachment({ 
    ...
    final _path = r'/apis/api.console.halo.run/v1alpha1/attachments/-/upload-from-url';
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AttachmentList>> searchAttachments({ 
    int? page,
    int? size,
    ...
    final _path = r'/apis/api.console.halo.run/v1alpha1/attachments';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [groupName] - The name of the group to which the attachment belongs
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [Attachment] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Attachment>> uploadAttachment({ 
    ...
    final _path = r'/apis/api.console.halo.run/v1alpha1/attachments/upload';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        r'file': file,
        if (groupName != null) r'groupName': encodeFormParameter(_serializers, groupName, const FullType(String)),
        r'policyName': encodeFormParameter(_serializers, policyName, const FullType(String)),
      });
