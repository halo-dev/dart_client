...
class NotificationV1alpha1Api {
  ...
  const NotificationV1alpha1Api(this._dio, this._serializers);
  ...
  Future<Response<Notification>> createNotification({ 
    ...
    final _path = r'/apis/notification.halo.run/v1alpha1/notifications';
    ...
    try {
      const _type = FullType(Notification);
      _bodyData = notification == null ? null : _serializers.serialize(notification, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteNotification({ 
    ...
    final _path = r'/apis/notification.halo.run/v1alpha1/notifications/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationList>> listNotification({ 
    int? page,
    int? size,
  ...
  /// Returns a [Future] containing a [Response] with a [Notification] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Notification>> patchNotification({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [Notification] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Notification>> updateNotification({ 
    required String name,
    Notification? notification,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
