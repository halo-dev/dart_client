...
import 'package:halo_client/src/model/config_map.dart';
import 'package:halo_client/src/model/config_map_list.dart';
...
class ConfigMapV1alpha1Api {
  ...
  const ConfigMapV1alpha1Api(this._dio, this._serializers);

  /// createConfigMap
  /// Create ConfigMap
  ///
  /// Parameters:
  /// * [configMap] - Fresh configmap
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ConfigMap] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ConfigMap>> createConfigMap({ 
    ConfigMap? configMap,
    ...
    final _path = r'/api/v1alpha1/configmaps';
    ...
    try {
      const _type = FullType(ConfigMap);
      _bodyData = configMap == null ? null : _serializers.serialize(configMap, specifiedType: _type);
    ...
    ConfigMap? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ConfigMap),
      ) as ConfigMap;
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteConfigMap({ 
    ...
    final _path = r'/api/v1alpha1/configmaps/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ConfigMap] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ConfigMap>> getConfigMap({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ConfigMapList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ConfigMapList>> listConfigMap({ 
    int? page,
    int? size,
    ...
    ConfigMapList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ConfigMapList),
      ) as ConfigMapList;
  ...
  /// Returns a [Future] containing a [Response] with a [ConfigMap] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ConfigMap>> patchConfigMap({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [ConfigMap] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ConfigMap>> updateConfigMap({ 
    required String name,
    ConfigMap? configMap,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
