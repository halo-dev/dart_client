...
import 'package:halo_client/src/model/auth_provider.dart';
import 'package:halo_client/src/model/auth_provider_list.dart';
...
class AuthProviderV1alpha1Api {
  ...
  const AuthProviderV1alpha1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AuthProvider] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthProvider>> createAuthProvider({ 
    ...
    final _path = r'/apis/auth.halo.run/v1alpha1/authproviders';
    ...
    try {
      const _type = FullType(AuthProvider);
      _bodyData = authProvider == null ? null : _serializers.serialize(authProvider, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteAuthProvider({ 
    ...
    final _path = r'/apis/auth.halo.run/v1alpha1/authproviders/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [AuthProvider] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthProvider>> getAuthProvider({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AuthProviderList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthProviderList>> listAuthProvider({ 
    int? page,
    int? size,
    ...
    AuthProviderList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AuthProviderList),
      ) as AuthProviderList;
    ...
    return Response<AuthProviderList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [AuthProvider] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthProvider>> patchAuthProvider({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [AuthProvider] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthProvider>> updateAuthProvider({ 
    required String name,
    AuthProvider? authProvider,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
