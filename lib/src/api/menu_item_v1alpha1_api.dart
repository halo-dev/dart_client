...
import 'package:halo_client/src/model/menu_item_list.dart';
...
class MenuItemV1alpha1Api {
  ...
  const MenuItemV1alpha1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [MenuItem] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MenuItem>> createMenuItem({ 
    MenuItem? menuItem,
    ...
    final _path = r'/api/v1alpha1/menuitems';
    ...
    try {
      ...
      _bodyData = menuItem == null ? null : _serializers.serialize(menuItem, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteMenuItem({ 
    ...
    final _path = r'/api/v1alpha1/menuitems/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [MenuItem] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MenuItem>> getMenuItem({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [MenuItemList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MenuItemList>> listMenuItem({ 
    int? page,
    int? size,
    ...
    MenuItemList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(MenuItemList),
      ) as MenuItemList;
  ...
  /// Returns a [Future] containing a [Response] with a [MenuItem] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MenuItem>> patchMenuItem({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [MenuItem] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MenuItem>> updateMenuItem({ 
    required String name,
    MenuItem? menuItem,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
