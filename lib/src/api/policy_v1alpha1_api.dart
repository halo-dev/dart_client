...
import 'package:halo_client/src/model/policy.dart';
import 'package:halo_client/src/model/policy_list.dart';
...
class PolicyV1alpha1Api {
  ...
  const PolicyV1alpha1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Policy] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Policy>> createPolicy({ 
    Policy? policy,
    ...
    final _path = r'/apis/storage.halo.run/v1alpha1/policies';
    ...
    try {
      const _type = FullType(Policy);
      _bodyData = policy == null ? null : _serializers.serialize(policy, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deletePolicy({ 
    ...
    final _path = r'/apis/storage.halo.run/v1alpha1/policies/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Policy] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Policy>> getPolicy({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PolicyList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PolicyList>> listPolicy({ 
    int? page,
    int? size,
    ...
    PolicyList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PolicyList),
      ) as PolicyList;
  ...
  /// Returns a [Future] containing a [Response] with a [Policy] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Policy>> patchPolicy({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [Policy] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Policy>> updatePolicy({ 
    required String name,
    Policy? policy,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
