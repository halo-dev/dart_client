...
import 'package:halo_client/src/model/thumbnail.dart';
import 'package:halo_client/src/model/thumbnail_list.dart';
...
class ThumbnailV1alpha1Api {
  ...
  const ThumbnailV1alpha1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Thumbnail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Thumbnail>> createThumbnail({ 
    Thumbnail? thumbnail,
    ...
    final _path = r'/apis/storage.halo.run/v1alpha1/thumbnails';
    ...
    try {
      const _type = FullType(Thumbnail);
      _bodyData = thumbnail == null ? null : _serializers.serialize(thumbnail, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteThumbnail({ 
    ...
    final _path = r'/apis/storage.halo.run/v1alpha1/thumbnails/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Thumbnail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Thumbnail>> getThumbnail({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ThumbnailList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ThumbnailList>> listThumbnail({ 
    int? page,
    int? size,
    ...
    ThumbnailList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ThumbnailList),
      ) as ThumbnailList;
  ...
  /// Returns a [Future] containing a [Response] with a [Thumbnail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Thumbnail>> patchThumbnail({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [Thumbnail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Thumbnail>> updateThumbnail({ 
    required String name,
    Thumbnail? thumbnail,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
