...
import 'package:halo_client/src/model/category_list.dart';
...
class CategoryV1alpha1Api {
  ...
  const CategoryV1alpha1Api(this._dio, this._serializers);
  ...
  Future<Response<Category>> createCategory({ 
    ...
    final _path = r'/apis/content.halo.run/v1alpha1/categories';
    ...
    try {
      ...
      _bodyData = category == null ? null : _serializers.serialize(category, specifiedType: _type);
  ...
  Future<Response<void>> deleteCategory({ 
    ...
    final _path = r'/apis/content.halo.run/v1alpha1/categories/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CategoryList>> listCategory({ 
    int? page,
    int? size,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CategoryList),
      ) as CategoryList;
