...
class TagV1alpha1ConsoleApi {
  ...
  const TagV1alpha1ConsoleApi(this._dio, this._serializers);
  ...
  /// * [keyword] - Post tags filtered by keyword.
  ...
  Future<Response<TagList>> listPostTags({ 
    int? page,
    int? size,
    ...
    final _path = r'/apis/api.console.halo.run/v1alpha1/tags';
