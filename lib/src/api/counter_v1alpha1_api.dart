...
import 'package:halo_client/src/model/counter.dart';
import 'package:halo_client/src/model/counter_list.dart';
...
class CounterV1alpha1Api {
  ...
  const CounterV1alpha1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Counter] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Counter>> createCounter({ 
    Counter? counter,
    ...
    final _path = r'/apis/metrics.halo.run/v1alpha1/counters';
    ...
    try {
      const _type = FullType(Counter);
      _bodyData = counter == null ? null : _serializers.serialize(counter, specifiedType: _type);
    ...
    Counter? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(Counter),
      ) as Counter;
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteCounter({ 
    ...
    final _path = r'/apis/metrics.halo.run/v1alpha1/counters/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Counter] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Counter>> getCounter({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CounterList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CounterList>> listCounter({ 
    int? page,
    int? size,
    ...
    CounterList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CounterList),
      ) as CounterList;
  ...
  /// Returns a [Future] containing a [Response] with a [Counter] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Counter>> patchCounter({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [Counter] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Counter>> updateCounter({ 
    required String name,
    Counter? counter,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
