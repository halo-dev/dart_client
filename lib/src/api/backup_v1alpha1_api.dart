...
import 'package:halo_client/src/model/backup_list.dart';
...
class BackupV1alpha1Api {
  ...
  const BackupV1alpha1Api(this._dio, this._serializers);
  ...
  Future<Response<Backup>> createBackup({ 
    Backup? backup,
    ...
    final _path = r'/apis/migration.halo.run/v1alpha1/backups';
    ...
    try {
      const _type = FullType(Backup);
      _bodyData = backup == null ? null : _serializers.serialize(backup, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteBackup({ 
    ...
    final _path = r'/apis/migration.halo.run/v1alpha1/backups/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Backup] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Backup>> getBackup({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BackupList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BackupList>> listBackup({ 
    int? page,
    int? size,
    ...
    BackupList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BackupList),
      ) as BackupList;
  ...
  /// Returns a [Future] containing a [Response] with a [Backup] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Backup>> patchBackup({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [Backup] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Backup>> updateBackup({ 
    required String name,
    Backup? backup,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
