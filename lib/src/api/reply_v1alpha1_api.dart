...
import 'package:halo_client/src/model/reply_list.dart';
...
class ReplyV1alpha1Api {
  ...
  const ReplyV1alpha1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Reply] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Reply>> createReply({ 
    Reply? reply,
    ...
    final _path = r'/apis/content.halo.run/v1alpha1/replies';
    ...
    try {
      const _type = FullType(Reply);
      _bodyData = reply == null ? null : _serializers.serialize(reply, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteReply({ 
    ...
    final _path = r'/apis/content.halo.run/v1alpha1/replies/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Reply] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Reply>> getReply({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ReplyList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ReplyList>> listReply({ 
    int? page,
    int? size,
    ...
    ReplyList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ReplyList),
      ) as ReplyList;
  ...
  /// Returns a [Future] containing a [Response] with a [Reply] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Reply>> patchReply({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [Reply] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Reply>> updateReply({ 
    required String name,
    Reply? reply,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
