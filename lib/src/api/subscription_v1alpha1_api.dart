...
import 'package:halo_client/src/model/subscription.dart';
import 'package:halo_client/src/model/subscription_list.dart';
...
class SubscriptionV1alpha1Api {
  ...
  const SubscriptionV1alpha1Api(this._dio, this._serializers);
  ...
  Future<Response<Subscription>> createSubscription({ 
    ...
    final _path = r'/apis/notification.halo.run/v1alpha1/subscriptions';
    ...
    try {
      const _type = FullType(Subscription);
      _bodyData = subscription == null ? null : _serializers.serialize(subscription, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteSubscription({ 
    ...
    final _path = r'/apis/notification.halo.run/v1alpha1/subscriptions/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Subscription] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Subscription>> getSubscription({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SubscriptionList>> listSubscription({ 
    int? page,
    int? size,
  ...
  /// Returns a [Future] containing a [Response] with a [Subscription] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Subscription>> patchSubscription({ 
    required String name,
