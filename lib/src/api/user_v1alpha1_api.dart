...
import 'package:halo_client/src/model/user_list.dart';
...
class UserV1alpha1Api {
  ...
  const UserV1alpha1Api(this._dio, this._serializers);
  ...
  Future<Response<User>> createUser({ 
    ...
    final _path = r'/api/v1alpha1/users';
  ...
  Future<Response<void>> deleteUser({ 
    ...
    final _path = r'/api/v1alpha1/users/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserList>> listUser({ 
    int? page,
    int? size,
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> patchUser({ 
    required String name,
