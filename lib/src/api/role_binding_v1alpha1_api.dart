...
import 'package:halo_client/src/model/role_binding_list.dart';
...
class RoleBindingV1alpha1Api {
  ...
  const RoleBindingV1alpha1Api(this._dio, this._serializers);

  /// createRoleBinding
  /// Create RoleBinding
  ///
  /// Parameters:
  /// * [roleBinding] - Fresh rolebinding
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [RoleBinding] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RoleBinding>> createRoleBinding({ 
    ...
    final _path = r'/api/v1alpha1/rolebindings';
    ...
    try {
      const _type = FullType(RoleBinding);
      _bodyData = roleBinding == null ? null : _serializers.serialize(roleBinding, specifiedType: _type);
    ...
    RoleBinding? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RoleBinding),
      ) as RoleBinding;
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteRoleBinding({ 
    ...
    final _path = r'/api/v1alpha1/rolebindings/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [RoleBinding] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RoleBinding>> getRoleBinding({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RoleBindingList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RoleBindingList>> listRoleBinding({ 
    int? page,
    int? size,
    ...
    RoleBindingList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RoleBindingList),
      ) as RoleBindingList;
  ...
  /// Returns a [Future] containing a [Response] with a [RoleBinding] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RoleBinding>> patchRoleBinding({ 
    required String name,
  ...
  /// Parameters:
  /// * [name] - Name of rolebinding
  /// * [roleBinding] - Updated rolebinding
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [RoleBinding] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RoleBinding>> updateRoleBinding({ 
    required String name,
    RoleBinding? roleBinding,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
