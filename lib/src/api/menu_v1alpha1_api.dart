...
import 'package:halo_client/src/model/menu.dart';
import 'package:halo_client/src/model/menu_list.dart';
...
class MenuV1alpha1Api {
  ...
  const MenuV1alpha1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Menu] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Menu>> createMenu({ 
    Menu? menu,
    ...
    final _path = r'/api/v1alpha1/menus';
    ...
    try {
      const _type = FullType(Menu);
      _bodyData = menu == null ? null : _serializers.serialize(menu, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(Menu),
      ) as Menu;
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteMenu({ 
    ...
    final _path = r'/api/v1alpha1/menus/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [MenuList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MenuList>> listMenu({ 
    int? page,
    int? size,
    ...
    MenuList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(MenuList),
      ) as MenuList;
  ...
  /// Returns a [Future] containing a [Response] with a [Menu] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Menu>> patchMenu({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [Menu] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Menu>> updateMenu({ 
    required String name,
    Menu? menu,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
