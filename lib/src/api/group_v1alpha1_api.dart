...
import 'package:halo_client/src/model/group.dart';
import 'package:halo_client/src/model/group_list.dart';
...
class GroupV1alpha1Api {
  ...
  const GroupV1alpha1Api(this._dio, this._serializers);
  ...
  Future<Response<Group>> createGroup({ 
    ...
    final _path = r'/apis/storage.halo.run/v1alpha1/groups';
    ...
    try {
      ...
      _bodyData = group == null ? null : _serializers.serialize(group, specifiedType: _type);
  ...
  Future<Response<void>> deleteGroup({ 
    ...
    final _path = r'/apis/storage.halo.run/v1alpha1/groups/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GroupList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GroupList>> listGroup({ 
    int? page,
    int? size,
    ...
    GroupList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GroupList),
      ) as GroupList;
