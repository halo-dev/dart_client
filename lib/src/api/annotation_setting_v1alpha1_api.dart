...
import 'package:halo_client/src/model/annotation_setting_list.dart';
...
class AnnotationSettingV1alpha1Api {
  ...
  const AnnotationSettingV1alpha1Api(this._dio, this._serializers);

  /// createAnnotationSetting
  /// Create AnnotationSetting
  ///
  /// Parameters:
  /// * [annotationSetting] - Fresh annotationsetting
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AnnotationSetting] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AnnotationSetting>> createAnnotationSetting({ 
    ...
    final _path = r'/api/v1alpha1/annotationsettings';
    ...
    try {
      const _type = FullType(AnnotationSetting);
      _bodyData = annotationSetting == null ? null : _serializers.serialize(annotationSetting, specifiedType: _type);
    ...
    AnnotationSetting? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AnnotationSetting),
    ...
    return Response<AnnotationSetting>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [name] - Name of annotationsetting
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteAnnotationSetting({ 
    ...
    final _path = r'/api/v1alpha1/annotationsettings/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [AnnotationSetting] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AnnotationSetting>> getAnnotationSetting({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AnnotationSettingList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AnnotationSettingList>> listAnnotationSetting({ 
    int? page,
    int? size,
    ...
    AnnotationSettingList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AnnotationSettingList),
      ) as AnnotationSettingList;
    ...
    return Response<AnnotationSettingList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [AnnotationSetting] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AnnotationSetting>> patchAnnotationSetting({ 
    required String name,
  ...
  /// Parameters:
  /// * [name] - Name of annotationsetting
  /// * [annotationSetting] - Updated annotationsetting
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [AnnotationSetting] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AnnotationSetting>> updateAnnotationSetting({ 
    required String name,
    AnnotationSetting? annotationSetting,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
