...
import 'package:halo_client/src/model/single_page_list.dart';
...
class SinglePageV1alpha1Api {
  ...
  const SinglePageV1alpha1Api(this._dio, this._serializers);

  /// createSinglePage
  /// Create SinglePage
  ///
  /// Parameters:
  /// * [singlePage] - Fresh singlepage
  ...
  Future<Response<SinglePage>> createSinglePage({ 
    ...
    final _path = r'/apis/content.halo.run/v1alpha1/singlepages';
    ...
    try {
      const _type = FullType(SinglePage);
      _bodyData = singlePage == null ? null : _serializers.serialize(singlePage, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteSinglePage({ 
    ...
    final _path = r'/apis/content.halo.run/v1alpha1/singlepages/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [SinglePage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SinglePage>> getSinglePage({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SinglePageList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SinglePageList>> listSinglePage({ 
    int? page,
    int? size,
    ...
    SinglePageList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SinglePageList),
      ) as SinglePageList;
    ...
    return Response<SinglePageList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [SinglePage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SinglePage>> patchSinglePage({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [SinglePage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SinglePage>> updateSinglePage({ 
    required String name,
    SinglePage? singlePage,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
