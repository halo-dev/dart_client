...
import 'package:halo_client/src/model/plugin.dart';
import 'package:halo_client/src/model/plugin_list.dart';
...
class PluginV1alpha1Api {
  ...
  const PluginV1alpha1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Plugin] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Plugin>> createPlugin({ 
    Plugin? plugin,
    ...
    final _path = r'/apis/plugin.halo.run/v1alpha1/plugins';
    ...
    try {
      const _type = FullType(Plugin);
      _bodyData = plugin == null ? null : _serializers.serialize(plugin, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deletePlugin({ 
    ...
    final _path = r'/apis/plugin.halo.run/v1alpha1/plugins/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Plugin] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Plugin>> getPlugin({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PluginList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PluginList>> listPlugin({ 
    int? page,
    int? size,
    ...
    PluginList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PluginList),
      ) as PluginList;
  ...
  /// Returns a [Future] containing a [Response] with a [Plugin] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Plugin>> patchPlugin({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [Plugin] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Plugin>> updatePlugin({ 
    required String name,
    Plugin? plugin,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
