...
import 'package:halo_client/src/model/role_list.dart';
...
class RoleV1alpha1Api {
  ...
  const RoleV1alpha1Api(this._dio, this._serializers);
  ...
  Future<Response<Role>> createRole({ 
    Role? role,
    ...
    final _path = r'/api/v1alpha1/roles';
    ...
    try {
      const _type = FullType(Role);
      _bodyData = role == null ? null : _serializers.serialize(role, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteRole({ 
    ...
    final _path = r'/api/v1alpha1/roles/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RoleList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RoleList>> listRole({ 
    int? page,
    int? size,
    ...
    RoleList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RoleList),
      ) as RoleList;
  ...
  /// Returns a [Future] containing a [Response] with a [Role] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Role>> patchRole({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [Role] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Role>> updateRole({ 
    required String name,
    Role? role,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
