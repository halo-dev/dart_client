...
import 'package:halo_client/src/model/device_list.dart';
...
class DeviceV1alpha1Api {
  ...
  const DeviceV1alpha1Api(this._dio, this._serializers);
  ...
  Future<Response<Device>> createDevice({ 
    Device? device,
    ...
    final _path = r'/apis/security.halo.run/v1alpha1/devices';
    ...
    try {
      ...
      _bodyData = device == null ? null : _serializers.serialize(device, specifiedType: _type);
  ...
  Future<Response<void>> deleteDevice({ 
    ...
    final _path = r'/apis/security.halo.run/v1alpha1/devices/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Device] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Device>> getDevice({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DeviceList>> listDevice({ 
    int? page,
    int? size,
  ...
  /// Returns a [Future] containing a [Response] with a [Device] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Device>> patchDevice({ 
    required String name,
