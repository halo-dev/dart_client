...
import 'package:halo_client/src/model/reason.dart';
import 'package:halo_client/src/model/reason_list.dart';
...
class ReasonV1alpha1Api {
  ...
  const ReasonV1alpha1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Reason] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Reason>> createReason({ 
    Reason? reason,
    ...
    final _path = r'/apis/notification.halo.run/v1alpha1/reasons';
    ...
    try {
      const _type = FullType(Reason);
      _bodyData = reason == null ? null : _serializers.serialize(reason, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteReason({ 
    ...
    final _path = r'/apis/notification.halo.run/v1alpha1/reasons/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Reason] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Reason>> getReason({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ReasonList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ReasonList>> listReason({ 
    int? page,
    int? size,
    ...
    ReasonList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ReasonList),
      ) as ReasonList;
  ...
  /// Returns a [Future] containing a [Response] with a [Reason] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Reason>> patchReason({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [Reason] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Reason>> updateReason({ 
    required String name,
    Reason? reason,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
