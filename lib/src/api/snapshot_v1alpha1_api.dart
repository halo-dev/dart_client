...
import 'package:halo_client/src/model/snapshot.dart';
import 'package:halo_client/src/model/snapshot_list.dart';
...
class SnapshotV1alpha1Api {
  ...
  const SnapshotV1alpha1Api(this._dio, this._serializers);
  ...
  Future<Response<Snapshot>> createSnapshot({ 
    ...
    final _path = r'/apis/content.halo.run/v1alpha1/snapshots';
    ...
    try {
      const _type = FullType(Snapshot);
      _bodyData = snapshot == null ? null : _serializers.serialize(snapshot, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteSnapshot({ 
    ...
    final _path = r'/apis/content.halo.run/v1alpha1/snapshots/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Snapshot] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Snapshot>> getSnapshot({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SnapshotList>> listSnapshot({ 
    int? page,
    int? size,
  ...
  /// Returns a [Future] containing a [Response] with a [Snapshot] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Snapshot>> patchSnapshot({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [Snapshot] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Snapshot>> updateSnapshot({ 
    required String name,
    Snapshot? snapshot,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
