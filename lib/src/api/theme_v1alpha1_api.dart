...
class ThemeV1alpha1Api {
  ...
  const ThemeV1alpha1Api(this._dio, this._serializers);
  ...
  Future<Response<Theme>> createTheme({ 
    Theme? theme,
    ...
    final _path = r'/apis/theme.halo.run/v1alpha1/themes';
    ...
    try {
      const _type = FullType(Theme);
      _bodyData = theme == null ? null : _serializers.serialize(theme, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteTheme({ 
    ...
    final _path = r'/apis/theme.halo.run/v1alpha1/themes/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Theme] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Theme>> getTheme({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ThemeList>> listTheme({ 
    int? page,
    int? size,
  ...
  /// Returns a [Future] containing a [Response] with a [Theme] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Theme>> patchTheme({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [Theme] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Theme>> updateTheme({ 
    required String name,
    Theme? theme,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
