...
import 'package:halo_client/src/model/setting_list.dart';
...
class SettingV1alpha1Api {
  ...
  const SettingV1alpha1Api(this._dio, this._serializers);
  ...
  Future<Response<Setting>> createSetting({ 
    Setting? setting,
    ...
    final _path = r'/api/v1alpha1/settings';
    ...
    try {
      const _type = FullType(Setting);
      _bodyData = setting == null ? null : _serializers.serialize(setting, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteSetting({ 
    ...
    final _path = r'/api/v1alpha1/settings/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Setting] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Setting>> getSetting({ 
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SettingList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SettingList>> listSetting({ 
    int? page,
    int? size,
    ...
    SettingList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SettingList),
      ) as SettingList;
  ...
  /// Returns a [Future] containing a [Response] with a [Setting] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Setting>> patchSetting({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [Setting] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Setting>> updateSetting({ 
    required String name,
    Setting? setting,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
