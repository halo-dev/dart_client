...
// tests for ExtensionPointDefinitionList
void main() {
  final instance = ExtensionPointDefinitionListBuilder();
  // TODO add properties to the builder and call build()

  group(ExtensionPointDefinitionList, () {
    ...
    // A chunk of items.
    // BuiltList<ExtensionPointDefinition> items
